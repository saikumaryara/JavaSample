class Example01{
 static int a = 10;/*Here a variable is allowed to access only to class
 without class name.When we want to access staic a variable 
from out side  of class We must use class name.var_name*/
 int x = 20;
 static void m1(){
 System.out.println(a);
 //System.out.println(x);//before  object creation u cannot access non-static varaible
 ...
 static void m3(){
 System.out.println(a);
 //System.out.println(x);//Non-static variable cannot be referenced with static context.
...
from out side  of class We must use class name.var_name*/
 ...
 int q = 60;
 /*Here p,q variables are
 local to method u cannot access outside of method*/
 System.out.println(p);
 System.out.println(q);
 System.out.println(p);
 System.out.println(q);
