...
public class VehicleTest {
	...
	public void run() throws ClassNotFoundException, FileNotFoundException, IOException {
		...
		// Before sorting call getObjects() method see output based on plate
		System.out.println();
		vr.getObjects();
		System.out.println();
		System.out.println("--------objects are added---------"+list1.size());
		System.out.println();
		// after sorting
		System.out.println("after sorting objects");
		System.out.println();
		//see licence ascending order is came
		TreeSet<Vehicle> t=new TreeSet<Vehicle>(list1);
		for(Vehicle v:t) {
